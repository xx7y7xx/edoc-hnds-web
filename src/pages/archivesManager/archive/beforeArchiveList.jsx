...
export default class BeforeArchiveList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      keyword: '',
  ...
  render() {
    return (
      <div>
        <Topbar currentSearch={this.advanceSearch} keywordChange={this.advanceSearch} placeholder={'请输入题名、文号、关键词、摘要、责任人'}/>
